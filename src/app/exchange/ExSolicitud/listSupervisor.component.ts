...
@Component({
    selector: 'solicitudSupervisorList',
    ...
    templateUrl: 'listSupervisor.html',
    encapsulation: ViewEncapsulation.None
})
export class ExSoliSupervisorListComponent extends GeBaseComponent implements OnInit{
    ...
    public activeBtnObservar: boolean = false;
    public activeBtnValidar: boolean = false;
    ...
    constructor(router: Router,
        ...
        super('ExSoliSupervisorListComponent', router, configuration, auth);
    }
    ...
    public buscar() {
        ...
        this.activeBtnObservar = false;
        this.activeBtnValidar = false;
    ...
    private activarBotones() {
        ...
        if (this.selectedDtos.length == 0) {
            ...
            this.activeBtnObservar = true;
            this.activeBtnValidar = true;
        } else {
            this.dto = null;
            this.id = null;
            this.activeBtnClonar = false;
    ...
    public formValidarSolicitudes(){
        if(this.selectedDtos && this.selectedDtos.length > 0)
            this.validarSolicitudes(this.selectedDtos);
    }
