...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            {label: 'Tablero', icon: 'dashboard', routerLink: ['/']},
            {
                label: 'Configuración', icon: 'settings_application',
                items: [
                    {label: 'Grupo de Parametros', icon: 'assistant', routerLink: ['/grupoParametroList']},
                    {label: 'Parametros', icon: 'gavel', routerLink: ['/parametroList']},
                    {label: 'Monedas', icon: 'launch', routerLink: ['/monedaList']},
                    {label: 'Socios de Negocio', icon: 'group', routerLink: ['/socioNegocioList']}
                ]
            },

            {
                ...
                items: [
                    {label: 'Usuario', icon: 'person', routerLink: ['/usuarioList']},
                    {label: 'Rol', icon: 'person', routerLink: ['/rolList']}
                ]
            }
        ];
    }
